...
public:
	cCentrodeTesteo(string CenterID, int ComunaTC, string NameTC);
	~cCentrodeTesteo();
	...
	void sendTest();//podria ser que este metodo mande el paciente al laboratorio y el paciente tenga un metodo random que defina el atributo de resultado de paciente
	void bajaPac();
};
